...
class UI:
    def __init__(self, screen, player=None):
        ...
        new_left_width = int(left_border_img.get_width() * end_cap_scale_factor)
        new_left_height = int(left_border_img.get_height() * end_cap_scale_factor)
        new_right_width = int(right_border_img.get_width() * end_cap_scale_factor)
        new_right_height = int(right_border_img.get_height() * end_cap_scale_factor)
    ...
    def draw(self, player_data, game_time_seconds,
             objective_text):
        ...
        total_left_elements_height = nick_surf.get_height() + hearts_spacing + hearts_height + stamina_bar_height + stamina_bar_margin_top_hearts
        ...
        stamina_bar_width_left_panel = int(left_section_area_width * 0.8)
        stamina_offset_x = -10
        stamina_offset_y = 10
        stamina_rect_x_left_panel = left_section_start_x + (
                left_section_area_width - stamina_bar_width_left_panel) // 2 + stamina_offset_x
        stamina_rect_y_left_panel = hearts_y + hearts_height + stamina_bar_margin_top_hearts + stamina_offset_y
        stamina_rect_left_panel = pygame.Rect(stamina_rect_x_left_panel, stamina_rect_y_left_panel,
                                              stamina_bar_width_left_panel, stamina_bar_height)
        ...
        current_y_middle = bar_rect.top + 20
        ...
        current_y_middle += objective_surf.get_height() + 5
        ...
        time_bar_width = int(middle_section_area_width * 0.75)
        time_rect_x = middle_section_start_x + (middle_section_area_width - time_bar_width) // 2
        time_rect_y = bar_rect.bottom - 60 - 16
        time_rect = pygame.Rect(time_rect_x, time_rect_y, time_bar_width, 16)
        ...
        time_ratio = game_time_seconds / 600
        fill_width_time = (time_rect.width - 4) * time_ratio
        fill_rect_time = pygame.Rect(time_rect.x + 2, time_rect.y + 2, fill_width_time, time_rect.height - 4)
        ...
        time_y_text = bar_rect.bottom - 25 - max(time_text_surf.get_height(), self.icons['time'].get_height())
        ...
        total_right_icons_width = (
                    self.icons['options'].get_width() + icon_margin + self.icons['pause'].get_width() + icon_margin +
