...
class WinScreen:
    def __init__(self, screen, character):
        ...
        self.image = pygame.image.load("assets/menu/win_screen_david.png").convert()
        if character == PlayerCharacter.BRANDON:
            self.image = pygame.image.load("assets/menu/win_screen_brandon.png").convert()
        elif character == PlayerCharacter.JANE:
            self.image = pygame.image.load("assets/menu/win_screen_jane.png").convert()
